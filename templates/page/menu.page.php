...
?>
<header class="p-2 <?php echo isset($_GET['page']) && $_GET['page'] !=='adminRank'? "mb-3" : "mb-0"; ?> border-bottom bg-dark" <?php echo isset($_GET['page']) && $_GET['page'] ==='adminMod'?  'style=" position: fixed; width:100% ;  z-index: 1000;"':'';?> >
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="./?page=home&layout=html" class="d-flex align-items-center m-1  link-light text-decoration-none">
                <span class="navbar-brand ">Wolfgameinc</span>
            </a>

            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li>
                    <a href="./?page=home&layout=html" class="nav-link px-2 link-<?php echo isset($_GET['page']) && $_GET['page']==='home'? 'primary' :'light'; ?>">Accueil</a>
                </li>
                <li>
            ...
            <?php if(isset($_GET['page']) && $_GET['page']==='home' ||  $_GET['page']==='category' ): ?>   
            ...
            <?php if(isset($_SESSION['user'])): ?>
                <div class="dropdown" id="dropdownProfils" >
                    ...
                    <ul class="dropdown-menu text-small">
                        ...
                        <li><a class="dropdown-item" href="./?page=adminRank&layout=html&adminRank=product">Mode administrateur</a></li>
                        <?php } ?>
                        <li><a class="dropdown-item" href="./?page=order&layout=html">Mes commandes</a></li>
